...
We aim to enhance instructional video generation with a diffusion-based framework, achieving state-of-the-art results in hand motion clarity and task-specific region localization. Visit [project page]([https://zhicaoisexcited.github.io/project_page/](https://excitedbutter.github.io/project_page/)) for more video resutls. 
